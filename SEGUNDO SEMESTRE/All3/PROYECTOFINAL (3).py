...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣿⣭⣤⡖⠀⠀⠠⣶⠀⣿⣷⡆⠀⠀''')
    ...
    while True:
        ...
        if nombre == "":
            ...
            print("El nombre no puede contener números ni caracteres especiales. Intenta nuevamente.")  
        else:
...
def mododerutina():
    ...
    while True:
        try:
            opcionrutina = int(input("Elige tu opción del 1 al 3: "))
            if 1 <= opcionrutina <= 3: 
                break
            else:
...
""")
        ...
        archivo.write("-------------------------------------------------------------------------------------\n")
        archivo.write("Ejercicios realizados:\n")
        for i in range(len(ejercicios)):
            archivo.write(f"- {ejercicios[i]}: {tiempos[i]} minutos\n")
        archivo.write("\n")
